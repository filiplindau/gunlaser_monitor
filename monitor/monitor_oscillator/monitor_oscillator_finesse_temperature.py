...
class MonitorOscillatorFinesseTemperature(MonitorCondition):
    """
    Monitors the operation of the oscillator pump laser Finesse.
    Checks for power,
    """
    def __init__(self, monitor_name, device_name):
        super(MonitorOscillatorFinesseTemperature, self).__init__(monitor_name)
    ...
    def check_condition(self):
        ...
        super(MonitorOscillatorFinesseTemperature, self).check_condition()
